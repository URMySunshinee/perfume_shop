    ...
    <div class="container pt-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2">
                    <i class="bi bi-geo-alt text-primary me-2"></i>123 Nguyễn Thiện
                    Thành, P5, Trà Vinh
                </p>
                <p class="mb-2">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex">
                    <a class="btn btn-outline-primary btn-square me-2" href="https://www.facebook.com/nhan172cm">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                        <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                      </svg>
                    </a>
                    <a class="btn btn-outline-primary btn-square me-2" href="https://chat.zalo.me/">
                    ...
                    <a class="btn btn-outline-primary btn-square me-2" href="https://www.tiktok.com/@iamnhaan">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tiktok" viewBox="0 0 16 16">
                        <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3z"/>
                      </svg>
                    </a>
                    <a class="btn btn-outline-primary btn-square" href="https://www.instagram.com/t.nhan69/">
    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-md-6 text-center text-md-start">
                <p class="mb-md-0">
                    &copy; <a class="text-white" href="{{url('/')}}">PERFUME SHOP</a>
                </p>
            </div>
        </div>
    </div>
